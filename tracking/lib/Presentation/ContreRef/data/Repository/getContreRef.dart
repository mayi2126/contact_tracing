...
class RetrieveContreRefRepositoryImpl
  ...
  Future<List<Referencement>> fetchAll() async {
    ...
    final response = await http.post(
      ...
      //TODOS: Remplacer l'ID utilisateur par celui de l'utilisateur connecté and ajouter les dates comme parametres
      body: jsonEncode({
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to load contre referencements');
    }
  }
}
