                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      20.verticalSpace,
                      Text("AKPATA",style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,color: Palette.primary),),

                      Spacer(),

                      Text("Mer, 21 Sept 25",style: TextStyle(fontWeight: FontWeight.bold,color: Palette.foreign, fontSize: 12),),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                       ...
                       20.verticalSpace,
                      Text("FOUT",style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,color: Palette.primary),),

                      Spacer(),

                      Text("Mer, 20 Sept 25",style: TextStyle(fontWeight: FontWeight.bold,color: Palette.foreign, fontSize: 12),),
